...
*  changed:
*    - lmin=1.8e-7 lmax=1.8e-7 wmin=1.8e-7 wmax=1.0e-4 version=3.1
*    + lmin=1.8e-7 lmax=1e-5   wmin=1.8e-7 wmax=1.0e-3 version=3.23
*
...
* not supported by gnucap built in bsim (yet).
*+ Php= 0.841
*+Ptp= 0                    
*+ Pta= 0
*+ Cta= 0
*+ Ctp= 0
*+N=1.0        
* introduces discrepancy between spectre and xyce
*+ Tref=27.0
...
.subckt sPMOS d g s b params: w='100E-6' l='1E-6'
*MP d g s b PMOS W='100E-6' L='1E-6' i guess this was not intended 
MP d g s b PMOS W=w L=l
.ends

.subckt sNMOS d g s b params: w='100E-6' l='1E-6'
** Oh merde: the parameter w is not passed in titan!
MN d g s b NMOS W=w L=l
.ends
